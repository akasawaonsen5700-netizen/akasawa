const DIRECTION_EXAMPLES = [
  {
    id: 1,
    title: "🍵 ぬる湯と何もしない贅沢（源泉のんびり湯治）",
    text: "平日の客室稼働を上げるために、仕事や日常で疲れた現代人やシニア層をターゲットにした静養（のんびり湯治）プランを企画したい。当館自慢のぬる湯温泉にゆっくり浸かり、何も考えずに脳と身体をリセットする極上のリラックス価値を訴求してほしい。"
  },
  {
    id: 2,
    title: "🏡 温泉付き和風貸別荘で過ごす極上の休日（ゆっくり寛ぐ大人の贅沢）",
    text: "プライベートを重視するご夫婦やカップル向けに、客室単価が最も高い温泉付き和風貸別荘『赤沢 和風の家』を最大限にアピールする贅沢プランを企画したい。誰にも邪魔されない完全プライベートな源泉かけ流し温泉（内風呂・露天風呂）を24時間独占でき、ゆっくりと時の流れを忘れて滞在できる価値相応の価格で販売したい。"
  },
  {
    id: 3,
